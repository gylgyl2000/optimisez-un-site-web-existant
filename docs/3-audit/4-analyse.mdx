...
:::info URL
L'URL de la page 2 est mal formatée.

Les URLs doivent être compréhensibles par un humain, et idéalement ne dépassent pas 115 caractères.
:::

:::info permaliens

Optimiser les permaliens en y ajoutant les mots clés visés.<br />
Cela facilitera grandement le travail d’exploration et d’indexation des algorithmes des moteurs de recherche.
:::

:::info page soignée

La "page 2" non fonctionnelle
:::
...
<!-- :::info Les liens n'ont pas de nom discernable

**Explication du problème :**<br />
Des liens qui n'ont pas de noms discernables

**Bonne pratique à adopter :**<br />
Le texte de lien (et le texte alternatif pour les images, lorsqu'il est utilisé comme lien)
qui est discernable, unique et focalisable améliore l'expérience de navigation pour les utilisateurs de lecteurs d'écran.

**Action recommandée :**

**Référence :**<br />
<a href="https://web.dev/link-name/?utm_source=lighthouse&utm_medium=devtools">Links do not have a discernible name</a>
